    ...
    <View>
      ...
      <ScrollView className="h-full">
        ...
        <View className="w-full h-auto px-6 flex-row flex-wrap justify-between">
          <View className="relative w-[45%] h-[100px] justify-center item-center ">
          ...
          <View className="relative w-[45%] h-[100px] justify-center item-center mt-8 rounded-[20px]">
            <Text className="text-center z-20 text-[20px] tracking-[2px] text-white">
              Informal
            </Text>
            <Image
        ...
        <View className="w-full flex-row justify-center py-14 px-6">
          <TouchableOpacity className="bg-[#3D5CFF] w-[50%] py-2 flex-row justify-center  items-center  rounded-md  ">
